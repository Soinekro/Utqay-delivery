<nav x-data="{ open: false }" class="fixed w-full justify-between bg-blue-900 border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @else
        <div >
                        <x-jet-responsive-nav-link href="{{ route('login') }}" class="text-sm text-white underline">Log in</x-jet-responsive-nav-link>

                        @if (Route::has('register'))
                            <x-jet-responsive-nav-link href="{{ route('register') }}" class=" text-sm text-white underline">Register</x-jet-responsive-nav-link>
                        @endif
        </div>
        @endauth
    </div>
